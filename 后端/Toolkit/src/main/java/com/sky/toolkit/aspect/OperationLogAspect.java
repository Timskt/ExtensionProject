package com.sky.toolkit.aspect;

import com.alibaba.fastjson.JSON;
import com.sky.toolkit.annotation.OptLog;
import com.sky.toolkit.entity.OperationLog;
import com.sky.toolkit.event.OperationLogEvent;
import com.sky.toolkit.util.IpUtil;
...
public class OperationLogAspect {
    ...
    @Pointcut("@annotation(com.sky.toolkit.annotation.OptLog)")
